...
def twenty_first_century_years?(year_list)
  # use #all? to return true when all of the years in the year_list (array) are between 2001 and 2100 ( INCLUDING 2001 AND 2100 🤬)
  # puts year_list
  year_list.all? { |n| 2001 <= n } & year_list.all? { |n| n <= 2100}
end
...
def valid_scores?(score_list, perfect_score)
  ...
  puts "score_list", score_list
  puts "perfect_score", perfect_score
